...
Includes custom, erc, font-lock, jde, semantic, speedbar, widget."
  ...
  (color-theme-install
   '(color-theme-xp
     ...
     (font-lock-comment-face ((t (:italic t :foreground "gray35" :slant oblique :height 0.9))))
     ...
     (fringe ((t (:background "lightyellow2"))))
