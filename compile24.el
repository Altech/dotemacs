;;;; This is besically compile.el of Emacs23.
;;;; But This is added the variable 'compilation-filter-start (of Emacs24).
;;;; Difference is only the lines including "compilation-filter-start".
